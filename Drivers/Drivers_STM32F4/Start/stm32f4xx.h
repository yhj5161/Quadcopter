 ...
 * @brief In the following line adjust the value of External High Speed oscillator (HSE)
 ...
 #define HSE_VALUE    ((uint32_t)8000000) /*!< Value of the External oscillator in Hz 我的飞控外部晶振为8MHZ*/
 #endif /* HSE_VALUE */
 ...
 * @brief In the following line adjust the External High Speed oscillator (HSE) Startup 
  ...
  #define HSE_STARTUP_TIMEOUT    ((uint16_t)0xFFFF)   /*!< Time out for HSE start up, 冷启动晶振需更长时间 */
