#ifndef __HEXA_MOVEMENT_TABLE_H
#define __HEXA_MOVEMENT_TABLE_H

#include "base.h"
#include "config.h"
#include <math.h>

/* ---- P1X~P6Z 宏（从 NodeHexa movements.cpp 搬过来） ---- */
#define SIN30   0.5f
#define COS30   0.866f
...
/* ---- standby 表 ---- */
static const Locations kStandby = {
...
const MovementTable standay_table = {&kStandby, 1, 20, (const int[]){0}, 1};
const MovementTable *standbyTable(void) { return &standay_table; }
const MovementTable *backwardTable(void) { return &backward_table; }
const MovementTable *beatswayTable(void) { return &beatsway_table; }
const MovementTable *climbTable(void) { return &climb_table; }
const MovementTable *forwardTable(void) { return &forward_table; }
const MovementTable *forwardfastTable(void) { return &forwardfast_table; }
const MovementTable *rotatexTable(void) { return &rotatex_table; }
const MovementTable *rotateyTable(void) { return &rotatey_table; }
const MovementTable *rotatezTable(void) { return &rotatez_table; }
const MovementTable *shiftleftTable(void) { return &shiftleft_table; }
const MovementTable *shiftrightTable(void) { return &shiftright_table; }
const MovementTable *turnleftTable(void) { return &turnleft_table; }
const MovementTable *turnrightTable(void) { return &turnright_table; }
const MovementTable *twistTable(void) { return &twist_table; }
